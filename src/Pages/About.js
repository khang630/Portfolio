...
const About = () => {
    return (
        <div name='About' className='w-full h-screen bg-gray-0 text-black min-h-[800px] '>
                ...
                <div className='shadow:lg w-full h-screen sm:max-w-[1500px] sm:max-h-[500px] flex flex-col justify-center items-center bg-[#1c1b20] '>
                    ...
                    <div className='max-w-[1000px] w-full  grid sm:grid-cols-2 gap-8 px-5 hover:scale-105 duration-300'>
                        <div className='sm:text-right'>
                            <p className='text-3xl font-bold  text-[#F68989] flex sm:justify-end'>Education <IoIosSchool className='ml-2 mt-1'/> </p>
                        </div>
                        <div>
                    ...
                    <div className='max-w-[1000px] w-full  grid sm:grid-cols-2 gap-8 px-5 hover:scale-105 duration-300 mt-4'>
                        <div className='sm:text-right'>
                            <p className='text-3xl font-bold  text-[#F68989] flex sm:justify-end'>Location <FaMapMarkerAlt className='ml-2 mt-1'/></p>
                        </div>
                        <div>
