            ...
            <div className='flex flex-col justify-center items-center h-full w-full'>
                ...
                <div className='max-w-[1000px] w-full  grid sm:grid-cols-2 gap-8 px-5 hover:scale-105 duration-300'>
                    <div className='sm:text-right'>
                        <p className='text-3xl font-bold text-right text-[#874356] flex sm:justify-end '>Piano <GiGrandPiano className='ml-2' /></p>
                        <a href='https://www.youtube.com/channel/UC8KwbjmSoB2M9KE0ZhD5XiQ' target="_blank" className='text-black flex sm:justify-end mt-2'><span className='border-b-2 inline border-black'>Youtube Channel</span> <BsFillArrowUpRightSquareFill className='ml-2 mt-1' /></a>
                    </div>
                    <div>
