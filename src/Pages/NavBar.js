...
import Logo from '../Images/KN.png'
...
const NavBar = () => {
    ...
    return (
        <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#3A3845] text-gray-300'>
            <div>
            ...
            <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#3A3845] flex flex-col justify-center items-center'}>
                <li className='py-6 text-4xl'>Home</li>
                <li className='py-6 text-4xl'>About</li>
                <li className='py-6 text-4xl'>Education</li>
                <li className='py-6 text-4xl'>Skills</li>
                <li className='py-6 text-4xl'>Projects</li>
                <li className='py-6 text-4xl'>Interests</li>
            </ul>
